                            ...
                            <tr>
                                <td>
                                    <div class="text" style="padding: 0 2.5em; text-align: center;">
                                        ...
                                        <p><a href="{{ url_for('predict_page') }}" class="btn btn-primary" style="border: radius 5px;background: #30e3ca;color: #ffffff;padding: 10px 15px;display: inline-block">Yes! Subscribe Me</a></p>
                                    </div>
                                </td>
                            </tr>
                        </table>
